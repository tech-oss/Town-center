...
export const buildings = [
  ...
  },
  {
    ...
    phone: null,
    image: "https://mma.prnewswire.com/media/2957815/Starlight_Investments_Starlight_Investments_Marks_Major_Mileston.jpg",
    hero: "https://mma.prnewswire.com/media/2957815/Starlight_Investments_Starlight_Investments_Marks_Major_Mileston.jpg",
    gallery: [
      "https://mma.prnewswire.com/media/2957815/Starlight_Investments_Starlight_Investments_Marks_Major_Mileston.jpg",
      "https://www.reminetwork.com/wp-content/uploads/Starlight_Investments-the-Waypoint-945x512.jpg",
      "https://mma.prnewswire.com/media/2957815/Starlight_Investments_Starlight_Investments_Marks_Major_Mileston.jpg",
      "https://www.reminetwork.com/wp-content/uploads/Starlight_Investments-the-Waypoint-945x512.jpg",
    ],
    description:
  ...
  },
  {
    ...
    phone: "01628 879 418",
    image: "https://cdn.bellway.co.uk/cdn-cgi/image/fit=cover,quality=85,format=auto,width=1200,height=800/plc/static/Bellway_WO_Set06_01_2.jpg",
    hero: "https://cdn.bellway.co.uk/cdn-cgi/image/fit=cover,quality=85,format=auto,width=1400,height=900/plc/static/Bellway_WO_Set06_01_2.jpg",
    gallery: [
      "https://cdn.bellway.co.uk/cdn-cgi/image/fit=cover,quality=85,format=auto,width=1200,height=800/plc/static/Bellway_WO_Set06_01_2.jpg",
      "https://cdn.bellway.co.uk/cdn-cgi/image/fit=cover,quality=85,format=auto,width=900,height=600/plc/static/Bellway_WO_Set06_01_2.jpg",
      "https://cms.bellway.co.uk/media/Future-Technologies/energy-efficient-homes-teaser.jpg",
      "https://cms.bellway.co.uk/media/pages/technology/solar-pv-teaser.jpg",
    ],
    description:
  ...
  },
  {
    ...
    tagline: "A unique place for people to live and thrive",
    location: "Manor Lane, Maidenhead SL6 2QW",
    status: "Available Now",
    website: "https://www.berkeleygroup.co.uk/developments/berkshire/maidenhead/spring-hill",
    email: "springhill@berkeleygroup.co.uk",
    phone: "01628 918 464",
    image: "https://www.berkeleygroup.co.uk/-/media/migration/berkeley-group/developments/spring-hill/gallery/exterior/spring-hill-exterior-gallery-3_30052025.ashx",
    hero: "https://www.berkeleygroup.co.uk/-/media/migration/berkeley-group/developments/spring-hill/gallery/exterior/spring-hill-exterior-gallery-3_30052025.ashx",
    gallery: [
      "https://www.berkeleygroup.co.uk/-/media/migration/berkeley-group/developments/spring-hill/gallery/exterior/spring-hill_exterior-image-1_02-07-2024.ashx",
      "https://www.berkeleygroup.co.uk/-/media/migration/berkeley-group/developments/spring-hill/gallery/showhome/spring-hill---showhome-gallery-kitchen-and-dining_28022025.ashx",
      "https://www.berkeleygroup.co.uk/-/media/migration/berkeley-group/developments/spring-hill/gallery/showhome/spring-hill---showhome-gallery-living-area_28022025.ashx",
      "https://www.berkeleygroup.co.uk/-/media/migration/berkeley-group/developments/spring-hill/gallery/showhome/spring-hill---showhome-gallery-garden_28022025.ashx",
    ],
    description:
      "Spring Hill by Berkeley Group is a unique collection of contemporary 1 to 5-bedroom homes and apartments in Maidenhead, designed for families and individuals seeking connection to both community and nature, with prices from £299,950.",
    longDescription: [
      "Spring Hill is a thoughtfully masterplanned community by the Berkeley Group, set on Manor Lane to the south of Maidenhead. Conceived as 'a unique place for people to live and thrive', the development blends contemporary, elegantly finished homes with generous green spaces and beautifully landscaped grounds — a genuine connection to nature that sits at the heart of everyday life here.",
      "The collection spans a wide range of needs: stylish one and two-bedroom apartments within the Manor House, through to three, four and five-bedroom detached family homes including the popular 'Dahlia' and 'Ivy' house styles. Each home is finished to Berkeley's renowned high specification, with elegant interiors, private balconies to selected apartments and dedicated parking throughout.",
      "Spring Hill is exceptionally well connected. Maidenhead Station — just 1.2 miles away — offers Elizabeth Line services reaching London Paddington in 19 minutes and Reading in 14. Braywick Nature Centre, Braywick Leisure Centre and Norden Farm Centre for the Arts are all within a short drive, while Maidenhead's award-winning restaurants, shops and schools are close at hand.",
    ],
    quickStats: [
      { icon: "🏡", label: "Home type", value: "Houses & Apartments" },
      { icon: "🛏", label: "Bedrooms", value: "1 – 5 bed" },
      { icon: "💷", label: "Prices from", value: "£299,950" },
      { icon: "✅", label: "Status", value: "Available Now" },
    ],
    amenities: [
      { icon: "🌿", text: "Landscaped green spaces" },
      { icon: "🏡", text: "Contemporary detached homes" },
      { icon: "🏢", text: "1 & 2-bed Manor House apartments" },
      { icon: "🌅", text: "Private balconies (apartments)" },
      { icon: "🚗", text: "Dedicated parking" },
      { icon: "🚂", text: "Elizabeth Line · 1.2 mi" },
      { icon: "🏗", text: "Berkeley high specification" },
      { icon: "👨‍👩‍👧", text: "Family-focused community" },
    ],
    nearbyPlaces: [
      { name: "Maidenhead Station (Elizabeth Line)", distance: "1.2 mi", mode: "train" },
      { name: "London Paddington", distance: "19 min", mode: "train" },
      { name: "Reading", distance: "14 min", mode: "train" },
      { name: "Braywick Nature Centre", distance: "4 min drive", mode: "car" },
      { name: "Braywick Leisure Centre", distance: "4 min drive", mode: "car" },
      { name: "Norden Farm Centre for the Arts", distance: "5 min drive", mode: "car" },
    ],
  },
  {
    slug: "harvest-hill",
    ...
    tagline: "Energy-efficient new homes connected to town by the Green Spine",
    location: "Harvest Hill Road, Maidenhead SL6 2GB",
    status: "Available Now",
    website: "https://www.taylorwimpey.co.uk/new-homes/maidenhead/harvest-hill",
    email: "harvesthill@taylorwimpey.com",
    phone: "01628 200 600",
    image: "https://lid.zoocdn.com/u/768/576/d2c73d44858e960d61507204985f7bddbcd8f5ba.jpg",
    hero: "https://lid.zoocdn.com/u/768/576/d2c73d44858e960d61507204985f7bddbcd8f5ba.jpg",
    gallery: [
      "https://lid.zoocdn.com/u/768/576/d2c73d44858e960d61507204985f7bddbcd8f5ba.jpg",
      "https://lid.zoocdn.com/u/768/576/48b7c6f3845e448525900fc3f5cc93542bd2378a.jpg",
      "https://lid.zoocdn.com/u/768/576/bcb85a4bebb812d9032371b417c2305745cf6c50.jpg",
      "https://lid.zoocdn.com/u/768/576/121bde58a041122df5541695ed7804d04c2f738a.jpg",
    ],
    description:
      "Harvest Hill by Taylor Wimpey is a collection of energy-efficient 2, 3, 4 and 5-bedroom new homes in Maidenhead, featuring triple glazing, EV charging and air-source heat pumps, connected to the town centre via the dedicated Green Spine walking and cycling trail.",
    longDescription: [
      "Harvest Hill is Taylor Wimpey's flagship Maidenhead development — a thoughtfully designed collection of 2, 3, 4 and 5-bedroom homes built for modern, sustainable family living. From the three-bedroom semi-detached 'Owlton' and 'Densdale' to the spacious four-bedroom detached 'Colford', every home combines generous, practical layouts with a forward-looking, energy-efficient specification.",
      "Sustainability is built in as standard. Each home features triple glazing, EV charging points and the latest air-source heat pump technology — significantly reducing both carbon footprint and running costs. Integrated kitchen appliances and flooring are included throughout, and every property comes with a reassuring 10-year NHBC warranty.",
      "Residents can reach Maidenhead town centre on a half-hour walk or cycle along the 'Green Spine', a dedicated traffic-free trail. Maidenhead Station is a five-minute drive away, offering direct Elizabeth Line services to London Paddington in around 30 minutes and Reading in 15 — making Harvest Hill an outstanding choice for commuters and families alike.",
    ],
    quickStats: [
      { icon: "🏡", label: "Home type", value: "Houses" },
      { icon: "🛏", label: "Bedrooms", value: "2 – 5 bed" },
      { icon: "💷", label: "Prices from", value: "£630,000" },
      { icon: "✅", label: "Status", value: "Available Now" },
    ],
    amenities: [
      { icon: "⚡", text: "EV charging points" },
      { icon: "🌡", text: "Air-source heat pumps" },
      { icon: "🪟", text: "Triple glazing" },
      { icon: "🍽", text: "Integrated kitchen appliances" },
      { icon: "🚶", text: "Green Spine cycling & walking trail" },
      { icon: "🏡", text: "Flooring included as standard" },
      { icon: "🏗", text: "NHBC 10-year warranty" },
      { icon: "🚂", text: "Station · 5 min drive" },
    ],
    nearbyPlaces: [
      { name: "Maidenhead Town Centre (Green Spine)", distance: "30 min walk", mode: "walk" },
      { name: "Maidenhead Station (Elizabeth Line)", distance: "5 min drive", mode: "car" },
      { name: "London Paddington", distance: "30 min", mode: "train" },
      { name: "Reading", distance: "15 min", mode: "train" },
      { name: "M4 Motorway (J8/9)", distance: "10 min drive", mode: "car" },
      { name: "Heathrow Airport", distance: "25 min drive", mode: "car" },
    ],
  },
];
