...
export const workplaceBuildings = [
  ...
  },
  {
    ...
    location: "One Maidenhead, Maidenhead SL6 1DY",
    status: "Ready Q4 2026",
    website: "https://www.trehus.work",
    email: "stuart.chambers@savills.com",
    phone: "07870 999 339",
    image: _img("mh-trehus-hero", 1400, 900),
    hero: _img("mh-trehus-hero", 1400, 900),
    gallery: [
      _img("mh-trehus-hero", 1200, 800),
      _img("mh-trehus-atrium", 900, 600),
      _img("mh-trehus-terrace", 900, 600),
      _img("mh-trehus-workspace", 900, 600),
    ],
