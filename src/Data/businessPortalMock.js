...
// declared here. These lists drive the signup form's pickers, and the same
// file drives admin's Register Business form and the public site's filters —
// one definition, so the three can no longer disagree about what a category
// is called or what its slug is.
export {
  BUSINESS_TYPES,
  FREELANCER_KINDS,
...
export { SUBSCRIPTION_PLANS } from "./taxonomy";
