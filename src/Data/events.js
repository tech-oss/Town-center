...
export const events = [
  ...
  // ── Dummy multi-event day (2026-08-26) — for testing the calendar's
  // multi-event day indicator and the day-detail card. Remove once real
  // events cover that date, or whenever this is no longer needed. ──
  {
    slug: "test-riverside-jazz-night",
    category: "Music",
    title: "Riverside Jazz Night",
    date: "Wednesday 26 August 2026",
    iso: "2026-08-26",
    time: "7pm – 10pm",
    location: "Coppa Club, Maidenhead",
    tickets: "£12 on the door",
    image: "https://picsum.photos/seed/test-jazz-night/900/650",
    excerpt: "An evening of live jazz on the riverside terrace.",
    standfirst: "An evening of live jazz on the riverside terrace.",
    body: [{ text: "Dummy test event." }],
    gallery: padGallery("test-jazz-night", ["https://picsum.photos/seed/test-jazz-night/900/650"]),
    social: {},
  },
  {
    slug: "test-5-a-side-tournament",
    category: "Sport",
    ...
    image: "https://picsum.photos/seed/test-5-a-side/900/650",
    excerpt: "Local teams compete in a one-day 5-a-side football tournament.",
    standfirst: "Local teams compete in a one-day 5-a-side football tournament.",
    body: [{ text: "Dummy test event." }],
    gallery: padGallery("test-5-a-side", ["https://picsum.photos/seed/test-5-a-side/900/650"]),
    social: {},
  },
  {
    slug: "test-community-litter-pick",
    category: "Community",
    title: "Community Litter Pick",
    date: "Wednesday 26 August 2026",
    iso: "2026-08-26",
    time: "9am – 11am",
    location: "Kidwells Park, Maidenhead",
    tickets: "Free, all welcome",
    image: "https://picsum.photos/seed/test-litter-pick/900/650",
    excerpt: "Join neighbours for a morning of tidying up Kidwells Park.",
    standfirst: "Join neighbours for a morning of tidying up Kidwells Park.",
    body: [{ text: "Dummy test event." }],
    gallery: padGallery("test-litter-pick", ["https://picsum.photos/seed/test-litter-pick/900/650"]),
    social: {},
  },
  {
    slug: "test-open-mic-theatre",
    category: "Theatre",
    title: "Open Mic Theatre Night",
    date: "Wednesday 26 August 2026",
    iso: "2026-08-26",
    time: "7:30pm – 9:30pm",
    location: "Norden Farm Centre for the Arts",
    tickets: "£5 on the door",
    image: "https://picsum.photos/seed/test-open-mic/900/650",
    excerpt: "Local performers share short scenes and monologues in a relaxed, informal setting.",
    standfirst: "Local performers share short scenes and monologues in a relaxed, informal setting.",
    body: [{ text: "Dummy test event." }],
    gallery: padGallery("test-open-mic", ["https://picsum.photos/seed/test-open-mic/900/650"]),
    social: {},
  },
];
...
// Shared by the homepage "What's On" grid and the See & Do mega menu's
// "Featured" column, so both always agree on which events are current.
...
// Only future one-offs + all recurring events, soonest first.
function upcomingFrom(list) {
  return list
    .filter((e) => e.recurringWeekday !== undefined || !e.iso || new Date(e.iso) >= today)
    .sort((a, b) => sortDate(a) - sortDate(b));
}

// The events currently "featured" — i.e. shown on the homepage's What's On grid.
export const featuredEvents = upcomingFrom(events).slice(0, 3);
