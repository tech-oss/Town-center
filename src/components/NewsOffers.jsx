            ...
            return (
              <Link
                ...
                style={{
                  ...
                  border: featured ? "1.5px solid var(--sage)" : "1px solid rgba(255,255,255,0.45)",
                  boxShadow: featured
              ...
              >
                ...
                <div className="flex flex-col flex-1 min-w-0 md:p-3 md:pt-4">
                  ...
                  <p className="text-xs md:text-sm leading-relaxed mb-3 line-clamp-3" style={{ color: "var(--ink)", opacity: 0.72 }}>
                    {post.excerpt}
                  </p>
