...
export default function EventsCalendarPage() {
  ...
  const cells = useMemo(() => {
    ...
    return arr;
  }, [y, m, startWeekday, daysInMonth]);

  // Events occurring this month (for the list below)
      ...
      <section className="py-12 md:py-16 px-6 md:px-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/events" className="text-sm font-semibold" style={{ color: "var(--forest)" }}>View all events →</Link>
          </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold" style={{ color: "var(--forest)" }}>{MONTHS[m]} {y}</h2>
