...
const SUBSCRIPTIONS = [
  { id: "s1", business: "Bloom Florist", owner: "Sarah Mitchell", tier: "Premium", status: "Active", renewal: "2026-09-12", monthlyFee: 79, paymentStatus: "Paid", history: [
  ...
  { id: "s2", business: "James's Kitchen", owner: "James Okafor", tier: "Standard", status: "Active", renewal: "2026-07-01", monthlyFee: 39, paymentStatus: "Paid", history: [
    { date: "2026-06-01", event: "Payment received £39", type: "payment" },
    { date: "2025-06-01", event: "Subscription started — Standard", type: "start" },
  ]},
  { id: "s3", business: "Maidenhead Gifts", owner: "Linda Forsythe", tier: "Basic", status: "Downgraded", renewal: "2026-07-08", monthlyFee: 0, paymentStatus: "Failed", history: [
  ...
  { id: "s4", business: "The Clubhouse", owner: "Patrick Dunn", tier: "Premium", status: "Active", renewal: "2027-01-07", monthlyFee: 79, paymentStatus: "Paid", history: [
  ...
  { id: "s5", business: "Spice Garden", owner: "Anita Sharma", tier: "Standard", status: "Trial", renewal: "2026-07-10", monthlyFee: 0, paymentStatus: "Trial", history: [
