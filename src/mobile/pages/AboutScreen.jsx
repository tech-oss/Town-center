    ...
    <MobileShell noPadding>
      <div className="flex flex-col">
        <div className="relative">
          ...
          <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, rgba(12,20,24,0.35) 0%, rgba(12,20,24,0.05) 55%, transparent 100%)" }} />
        ...
        <div className="px-5 pt-5 flex flex-col gap-6 pb-6 mobile-stagger">
          ...
          <div className="grid grid-cols-3 gap-3">
            {aboutStats.map((s) => (
              <div key={s.label} className="rounded-2xl p-3 text-center" style={{ backgroundColor: "rgba(82,199,182,0.1)" }}>
