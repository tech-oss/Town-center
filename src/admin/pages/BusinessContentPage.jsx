          ...
          <div className="max-w-3xl pb-10">
            ...
            {!isPremium(listing.plan) && (
              <div className="rounded-xl px-4 py-3 mb-5 text-xs flex items-start gap-3 flex-wrap"
                ...
                <span className="flex-1 min-w-[200px]">Only the business name, address, phone, email and map pin can be edited, plus the stock hero picture only you can upload. Fields marked 🔒 Visibility Plan stay locked until the business is moved onto the Visibility Plan.</span>
