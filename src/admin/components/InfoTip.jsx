  ...
  return (
    <span className="relative inline-flex group align-middle">
      <span
        ...
        style={{ backgroundColor: "rgba(10,25,47,0.07)", color: "#6B7280" }}
      >
        i
      </span>
      <span
        ...
        style={{
          ...
          boxShadow: "0 10px 28px rgba(10,25,47,0.38)",
        }}
      >
        {text}
        <span
          className="absolute left-1/2 -translate-x-1/2 top-full"
          style={{ width: 0, height: 0, borderLeft: "5px solid transparent", borderRight: "5px solid transparent", borderTop: "5px solid #0A192F" }}
        />
      </span>
    </span>
  );
